        ...
        <nav className="mx-auto flex h-20 max-w-7xl items-center justify-between px-6 lg:px-8">
         ...
         font-medium text-gray-600 transition-colors hover:text-black"
          ...
          <div className="hidden items-center gap-4 md:flex">
            ...
            <a
              href="/sell"
              className=" rounded-full bg-black px-5 py-2.5 text-sm font-medium text-white transition-transform hover:scale-110"
            >
              List Property
            </a>
          </div>
        ...
        {isOpen && (
          <div className="border-t bg-white px-6 py-6 md:hidden">
            <div className="flex flex-col gap-5">
              ...
              <a
                href="/sell "
                className="rounded-full bg-black px-5 py-5 text-center font-medium text-white"
              >
                List Property
              </a>
            </div>
